            ...
            <div class="header-menu">
                ...
                <div class="container">
                    <div class="pull-right">
                       <a href="profile_user.php" class="btn btn-primary btn-sm active">Profile</a>
                ...
                <div class="card text-white bg-flat-color-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-stripped table-bordered">
                            ...
                            $query="SELECT department,idea,title,statement,status FROM projects WHERE email='$email'";
                            $rs=mysqli_query($link,$query);
                            print "<tr> <th>Department";
                            print "</th> <th>Status OF Idea";
                            print "</th> <th>Project Title";
                            print "</th> <th>Status";
                              ...
                              else if($status=="DENIED")
                           {
                            $color='red';
                               $bg="lightgray";
                                ...
                                echo "<me style='color:$color;background:$bg;'>".$status."</me>";
                                 print "</td> </tr>";
                           }
